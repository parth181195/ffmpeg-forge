...
export class ThumbnailExtractor {
   ...
   */
  private async extractByTime(inputPath: string, config: ThumbnailConfig): Promise<ThumbnailResult> {
   ...
   */
  private async extractByCount(inputPath: string, config: ThumbnailConfig): Promise<ThumbnailResult> {
   ...
   */
  private async extractByInterval(inputPath: string, config: ThumbnailConfig): Promise<ThumbnailResult> {
   ...
   */
  private async extractByScene(inputPath: string, config: ThumbnailConfig): Promise<ThumbnailResult> {
   ...
   */
  private async extractBestQuality(inputPath: string, config: ThumbnailConfig): Promise<ThumbnailResult> {
