...
export class FilterBuilder {
  ...
  static buildSharpenFilter(sharpen: SharpenFilter): string {
    ...
    if (sharpen.chroma_msize_x !== undefined) parts.push(`chroma_msize_x=${sharpen.chroma_msize_x}`);
    if (sharpen.chroma_msize_y !== undefined) parts.push(`chroma_msize_y=${sharpen.chroma_msize_y}`);
  ...
  static buildDownscaleFilter(downscale: DownscalingOptions): string[] {
    ...
    const algorithm = downscale.preserveDetails 
      ? 'lanczos' 
      : downscale.algorithm;
